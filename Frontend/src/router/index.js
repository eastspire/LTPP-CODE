...
},
{
    ...
    children: [
        ...
        },
        {
            ...
            name: 'onequestion',
            component: () =>
                import('../views/home/onequestion.vue'),
            meta: {
                title: '问题详情',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'sendquestion',
            component: () =>
                import('../views/home/sendquestion.vue'),
            meta: {
                title: '问答圈提问',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'myquestion',
            component: () =>
                import('../views/back/myquestion.vue'),
            meta: {
                title: '问答管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'questionlist',
            component: () =>
                import('../views/home/questionlist.vue'),
            meta: {
                title: '问答圈',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'onevideo',
            component: () =>
                import('../views/home/onevideo.vue'),
            meta: {
                title: '视频',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'lovevideo',
            component: () =>
                import('../views/back/lovevideo.vue'),
            meta: {
                title: '收藏的视频',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'fabulousvideo',
            component: () =>
                import('../views/back/fabulousvideo.vue'),
            meta: {
                title: '点赞的视频',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'problemcode',
            component: () =>
                import('../views/home/problemcode.vue'),
            meta: {
                title: '题目提交历史',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            component: () =>
                import('../views/home/oneproblemsolve.vue'),
            meta: {
                title: '题解社区',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'staticfile',
            component: () =>
                import('../views/home/staticfile.vue'),
            meta: {
                title: '文件详情',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'mynotice',
            component: () =>
                import('../views/back/mynotice.vue'),
            meta: {
                title: '消息通知',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            component: () =>
                import('../views/root/shortsentencemanage.vue'),
            meta: {
                title: '短句管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'photomanage',
            component: () =>
                import('../views/root/photomanage.vue'),
            meta: {
                title: '首页侧边栏图片管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'videomanage',
            component: () =>
                import('../views/root/videomanage.vue'),
            meta: {
                title: '视频管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'cloudfile',
            component: () =>
                import('../views/home/cloudfile.vue'),
            meta: {
                title: '云盘',
                keepAlive: true,
                index: 2,
            ...
            name: 'onecontest',
            component: () =>
                import('../views/home/onecontest.vue'),
            meta: {
                title: '竞赛详情',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'myjoincontest',
            component: () =>
                import('../views/back/myjoincontest.vue'),
            meta: {
                title: '我的竞赛',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'updatacontest',
            component: () =>
                import('../views/admin/updatacontest.vue'),
            meta: {
                title: '更新竞赛',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'addcontest',
            component: () =>
                import('../views/admin/addcontest.vue'),
            meta: {
                title: '添加竞赛',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'managecontest',
            component: () =>
                import('../views/admin/managecontest.vue'),
            meta: {
                title: '竞赛管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'oneproblem',
            component: () =>
                import('../views/home/oneproblem.vue'),
            meta: {
                title: '题目详情',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'problemmanage',
            component: () =>
                import('../views/admin/problemmanage.vue'),
            meta: {
                title: '题目管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'dayproblem',
            component: () =>
                import('../views/home/dayproblem.vue'),
            meta: {
                title: '每日一题',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'userpage',
            component: () =>
                import('../views/home/userpage.vue'),
            meta: {
                title: '用户主页',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'goodsmanage',
            component: () =>
                import('../views/root/goodsmanage.vue'),
            meta: {
                title: '商品管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'notice',
            component: () =>
                import('../views/root/noticemanage.vue'),
            meta: {
                title: '公告管理',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            component: () =>
                import('../views/back/updateonearticle.vue'),
            meta: {
                title: '文章更新',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            component: () =>
                import('../views/admin/oneproblemmanage.vue'),
            meta: {
                title: '题目编辑',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'onearticle',
            component: () =>
                import('../views/home/onearticle.vue'),
            meta: {
                title: '文章详情',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'userarticle',
            component: () =>
                import('../views/root/userarticle.vue'),
            meta: {
                title: '用户文章',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'allarticle',
            component: () =>
                import('../views/home/allarticle.vue'),
            meta: {
                title: '文章广场',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'classteach',
            component: () =>
                import('../views/home/classteach.vue'),
            meta: {
                title: '在线课堂',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'randomarticle',
            component: () =>
                import('../views/home/randomarticle.vue'),
            meta: {
                title: '随机文章',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'videocommunity',
            component: () =>
                import('../views/home/videocommunity.vue'),
            meta: {
                title: '短视频',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'mycodehistory',
            component: () =>
                import('../views/home/mycodehistory.vue'),
            meta: {
                title: '我的提交记录',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            name: 'allcodehistory',
            component: () =>
                import('../views/home/allcodehistory.vue'),
            meta: {
                title: '全站提交记录',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            path: '/lovearticle',
            component: () =>
                import('../views/back/lovearticle.vue'),
            meta: {
                title: '收藏的文章',
                keepAlive: true,
                index: 2,
        ...
        },
        {
            ...
            component: () =>
                import('../views/back/myarticlemanage.vue'),
            meta: {
                title: '我的文章管理',
                keepAlive: true,
                index: 2,
...
try {
    is_electron = typeof navigator !== 'undefined' && navigator.userAgent.toLowerCase().indexOf('electron') !== -1;
} catch (err) {
    is_electron = false;
}

  ...
  <div @contextmenu.prevent="" v-show="loginimage.length > 0 || isloginmusic">
    <div
      style="
        ...
        text-align: center;
        width: 8.8rem;
        background-color: rgba(var(--ltpp-main-bk-color), 0.36) !important;
      "
      v-if="!isloginmusic"
    >
      <div style="text-align: center">
        <div style="height: 0.46rem"></div>
        <p style="color: var(--ltpp-title-color); font-size: 1.26rem">
          网易云音乐
        </p>
        <p
          style="color: deeppink; margin-top: 0rem; font-size: 0.78rem"
          v-show="isold"
        >
          图片已经过期
        </p>

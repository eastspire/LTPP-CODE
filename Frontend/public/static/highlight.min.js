...
return n?Number(n):(e=>z.includes(e.toLowerCase()))(e)?0:1}const P={},K=e=>{},q=(e,...n)=>{H=(e,n)=>{
P[`${e}/${n}`]},Z=Error();function G(e,n,{key:t}){let a=0;const i=e[t],r={},s={}
...
}),e.children.length>0&&(d.ignoreUnescapedHTML,

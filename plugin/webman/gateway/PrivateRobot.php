...
class PrivateRobot
{
    ...
    static $robot_root_default =
        ...
        '19.购买私人轻量云服务器，系统自带多种编程语言的运行环境和在线VSCODE（序号后第一个空格后为SSH登录密码，若不设置系统会自动生成随机密码，若已购买可查看登录命令和密码）';

    static $robot_admin_default =
        '您可以输入以下单个序号来进行操作：' . "\n" .
        '1.重判题目在竞赛中的代码（例如：1 A+B）（序号后第一个空格后为重判的题目完整标题）' . "\n" .
        '2.购买私人轻量云服务器，系统自带多种编程语言的运行环境和在线VSCODE（序号后第一个空格后为SSH登录密码，若不设置系统会自动生成随机密码，若已购买可查看登录命令和密码）';

    static $robot_user_default =
        '您可以输入以下单个序号来进行操作：' . "\n" .
        '1.购买私人轻量云服务器，系统自带多种编程语言的运行环境和在线VSCODE（序号后第一个空格后为SSH登录密码，若不设置系统会自动生成随机密码，若已购买可查看登录命令和密码）';

 ...
 * @LastEditTime: 2023-08-12 08:06:56
 * @FilePath: \LTPP-CODE\app\controller\ArticleCommentImage.php
...
class ArticleCommentImage
{
    ...
    public function saveImage(Request $request)
    {
        ...
        $md5article_id = md5($request->header('id'));
        $newPath = Base::$LTPP_public_static_path . '/commentimage/' . $md5month . '/' . $md5article_id; // 目标文件夹
        ...
        if ($file && $file->isValid()) {
            ...
            return \json(['url' => Base::$GLOBlinuxurl . '/static/commentimage/' . $md5month . '/' . $md5article_id . '/' . $newName]);
        }

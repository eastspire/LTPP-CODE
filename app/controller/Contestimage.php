 ...
 * @LastEditTime: 2023-08-12 08:08:13
 * @FilePath: \LTPP-CODE\app\controller\Contestimage.php
 ...
 * @Date: 2023-01-12 12:38:58
 * @LastEditors: 18855190718 1491579574@qq.com
 * @LastEditTime: 2023-01-27 12:35:01
 * @FilePath: \LTPP\app\controller\Contestimage.php
 * @Description: Email:1491579574@qq.com
 * QQ:1491579574
...
class Contestimage
{
    ...
    public function saveImage(Request $request)
    {
        ...
        $newPath = Base::$LTPP_public_static_path . '/contestimage/' . $md5month; // 目标文件夹
        ...
        if ($file && $file->isValid()) {
            ...
            return \json(['url' => Base::$GLOBlinuxurl . '/static/contestimage/' . $md5month . '/' . $newName]);
        }

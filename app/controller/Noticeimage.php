 ...
 * @LastEditTime: 2023-08-12 08:08:30
 * @FilePath: \LTPP-CODE\app\controller\Noticeimage.php
...
class Noticeimage
{
    ...
    public function saveImage(Request $request)
    {
        ...
        $newPath = Base::$LTPP_public_static_path . '/noticeimage/' . $md5month; // 目标文件夹
        ...
        if ($file && $file->isValid()) {
            ...
            return \json(['url' => Base::$GLOBlinuxurl . '/static/noticeimage/' . $md5month . '/' . $newName]);
        }

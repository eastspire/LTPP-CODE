 ...
 * @LastEditTime: 2023-03-13 13:10:38
 * @FilePath: \LTPP\app\controller\Problemimage.php
...
class Problemimage
{
    ...
    public function saveImage(Request $request)
    {
        ...
        $newPath = Base::$LTPP_public_static_path . '/problemimage/' . $md5month; // 目标文件夹
        ...
        if ($file && $file->isValid()) {
            ...
            return \json(['url' => Base::$GLOBlinuxurl . '/static/problemimage/' . $md5month . '/' . $newName]);
        }
